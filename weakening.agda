...
module weakening where
  ...
  --                    Δ , Θ , Γ ⊢ θ , σ :s: Θ' , Γ' →
  --                    Δ , Θ , (Γ ,, (x , τ)) ⊢ θ , σ :s: Θ' , Γ'
  --   weaken-subst-Γ {Γ = Γ} (EFId x₁) (STAIdId x₂) = STAIdId (λ x τ x₃ → x∈∪l Γ _ x τ (x₂ x τ x₃) )
  ...
  -- mutual 
  --   weaken-subst-Θ : ∀{Γ Δ θ σ Γ' Θ Θ'} →
  --                    Δ , Θ , Γ ⊢ θ , σ :s: Θ' , Γ' →
  --                    Δ , typctx.[ Θ newtyp] , Γ ⊢ θ , σ :s: Θ' , Γ'
  --   weaken-subst-Θ (STAIdId x) = STAIdId x
