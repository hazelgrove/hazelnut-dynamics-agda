...
module preservation where
  ...
  lemma-tysubst : ∀{ Δ Γ Θ d τ t n } -> Δ , Γ , [ Θ newtyp] ⊢ d :: τ -> Δ , Γ , Θ ⊢ (TTyp[ t / n ] d) :: Typ[ t / n ] τ
  lemma-tysubst = {!!}
  ...
  preserve-trans bd (TATAp (TACast ta (TCForall x))) ITTApCast = TACast (TATAp ta) (~Typ[] x)
  preserve-trans bd (TATAp (TATLam x)) ITTLam = lemma-tysubst x
  ...
  preserve-trans bd (TACast ta x) (ITGround (MGForall x₁)) = TACast (TACast ta (TCForall TCHole1)) TCHole1
  preserve-trans bd (TACast ta TCHole2) (ITExpand (MGArr x₁)) = TACast (TACast ta TCHole2) (TCArr TCHole2 TCHole2)
  preserve-trans bd (TACast ta TCHole2) (ITExpand (MGForall x₁)) = TACast (TACast ta TCHole2) (TCForall TCHole2)
