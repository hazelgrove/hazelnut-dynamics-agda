...
module lemmas-freshness where
  ...
  mutual
    ...
    fresh-elab-synth1 apt (FRHTAp x₁) (ESTAp x₂ x₃ x₄) = FTAp (FCast (fresh-elab-ana1 apt x₁ x₄))
  ...
  mutual
    ...
    fresh-elab-synth2 (FTAp (FCast frsh)) (ESTAp x₂ x₃ x₄) = FRHTAp (fresh-elab-ana2 frsh x₄)
