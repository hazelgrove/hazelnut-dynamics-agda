...
module canonical-boxed-forms where
  ...
  canonical-boxed-forms-forall (TACast wt x) (BVVal ())
  canonical-boxed-forms-forall (TACast wt _) (BVForallCast x bv) = CBFCastForall (_ , _ , refl , x , wt )
  ...
  canonical-boxed-forms-coverage (TALam _ wt) (BVVal x₁) nb na nh nf = na _ _ refl
  ...
  canonical-boxed-forms-coverage (TACast wt x) (BVVal ()) nb na nh nf
  canonical-boxed-forms-coverage (TACast wt x) (BVArrCast x₁ bv) nb na nh nf = na _ _ refl
  canonical-boxed-forms-coverage (TACast wt x) (BVHoleCast x₁ bv) nb na nh nf = nh refl
  canonical-boxed-forms-coverage (TACast wt x) (BVForallCast x₁ x₂) nb na nh nf = nf _ refl
