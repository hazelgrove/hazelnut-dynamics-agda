...
module disjointness where
  ...
  mutual
    ...
    elab-new-disjoint-ana (HNTLam hn) (EATLam neq1 neq2 m wt) = elab-new-disjoint-ana hn wt
  ...
  mutual
    ...
    elab-disjoint-new-ana (EATLam neq1 neq2 m wt) x = HNTLam (elab-disjoint-new-ana wt x)
  ...
  mutual
    ...
    holes-delta-ana (HTLam h) (EATLam neq1 neq2 m wt) = holes-delta-ana h wt
