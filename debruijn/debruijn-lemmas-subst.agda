...
module debruijn.debruijn-lemmas-subst where
  ...
  --   ∀{m n Γ τ} → 
  --   Γ ⊢ τ wf →
  --   (ctx-extend-tvars (1+ n) Γ) ⊢ ↓ (m nat+ (1+ n)) 1 (↑ m (1+ (1+ n)) τ) wf
  -- wf-TTSub-helper3 {m = Z} {n = Z} (WFSkip wf) = WFVarS (WFSkip wf)
  -- wf-TTSub-helper3 {m = Z} {n = 1+ n} (WFSkip wf) = WFVarS (wf-TTSub-helper3 {m = Z} {n = n} (WFSkip wf))
  -- wf-TTSub-helper3 {m = 1+ m} {n = n} (WFSkip wf) = WFVarZ
  -- wf-TTSub-helper3 {m = Z} {n = Z} WFVarZ = WFVarS WFVarZ
  -- wf-TTSub-helper3 {m = Z} {n = 1+ n} WFVarZ = WFVarS (wf-TTSub-helper3 {m = Z} {n = n} WFVarZ)
  -- wf-TTSub-helper3 {m = Z} {n = Z} (WFVarS wf) = WFVarS (WFVarS wf)
  -- wf-TTSub-helper3 {m = Z} {n = 1+ n} (WFVarS wf) = WFVarS (wf-TTSub-helper3 {m = Z} {n = n} (WFVarS wf))
  -- wf-TTSub-helper3 {m = 1+ m} {n = Z} WFVarZ = WFVarZ
  -- wf-TTSub-helper3 {m = 1+ m} {n = 1+ n} WFVarZ = WFVarZ
  -- wf-TTSub-helper3 {m = 1+ m} {n = Z} (WFVarS wf) = WFVarS (wf-TTSub-helper3 {m = m} {n = Z} wf)
  ...
  -- ... | result rewrite sym (extend-tvar-comm n Γ) = WFForall result 
  ...
  wf-TTSub-helper {Γ = ∅} {n = Z} {τ1 = τ1} wf1 WFVarZ rewrite ↓↑invert Z τ1 = wf1
  wf-TTSub-helper {n = 1+ n} wf1 WFVarZ = WFVarZ 
  wf-TTSub-helper {Γ = τ , Γ} {n = Z} {τ1 = τ1} wf1 WFVarZ rewrite ↓↑invert Z τ1 = wf1
  wf-TTSub-helper {Γ = TVar, Γ} {n = Z} {τ1 = τ1} wf1 WFVarZ rewrite ↓↑invert Z τ1 = wf1
  wf-TTSub-helper {n = Z} wf1 (WFVarS wf2) = wf2
  wf-TTSub-helper {n = 1+ n} wf1 (WFVarS {n = m} wf2) with natEQ n m 
  wf-TTSub-helper {Γ = Γ} {1+ n} {τ1 = τ1} wf1 (WFVarS {n = m} wf2) | Inl refl = {!   !} --wf-TTSub-helper3 {m = Z} {n = n} wf1
  ...
  -- wf-TTSub-helper wf1 WFHole = WFHole
  -- wf-TTSub-helper wf1 (WFArr wf2 wf3) = WFArr (wf-TTSub-helper wf1 wf2) (wf-TTSub-helper wf1 wf3)
  -- wf-TTSub-helper {Γ = ∅} {n = Z} {τ1 = τ1} wf1 (WFVar WFVarZ) rewrite ↓↑invert Z τ1 = wf1
  -- wf-TTSub-helper {n = 1+ n} wf1 (WFVar WFVarZ) = (WFVar WFVarZ) 
  -- wf-TTSub-helper {Γ = τ , Γ} {n = Z} {τ1 = τ1} wf1 (WFVar WFVarZ) rewrite ↓↑invert Z τ1 = wf1
  -- wf-TTSub-helper {Γ = TVar, Γ} {n = Z} {τ1 = τ1} wf1 (WFVar WFVarZ) rewrite ↓↑invert Z τ1 = wf1
  -- wf-TTSub-helper {n = Z} wf1 (WFVar (WFVarS wf2)) = WFVar wf2
  -- wf-TTSub-helper {n = 1+ n} wf1 (WFVar (WFVarS {n = m} wf2)) with natEQ n m 
  -- wf-TTSub-helper {Γ = Γ} {1+ n} {τ1 = τ1} wf1 (WFVar (WFVarS {n = m} wf2)) | Inl refl = {!   !} --wf-TTSub-helper3 {m = Z} {n = n} wf1
  -- wf-TTSub-helper {n = 1+ n} wf1 (WFVar (WFVarS {n = m} wf2)) | Inr neq = {!   !} --wf-TTSub-helper2 neq wf2
  -- wf-TTSub-helper {Γ = Γ} {n = n} {τ1 = τ1} wf1 (WFForall wf2) with (↑compose Z (1+ n) τ1)
  -- ... | eq rewrite eq = WFForall (wf-TTSub-helper wf1 wf2) 

  wf-TTSub : ∀{Γ τ1 τ2} → (Γ ⊢ τ1 wf) → ((TVar, Γ) ⊢ τ2 wf) → (Γ ⊢ (TTSub Z τ1 τ2) wf)
  wf-TTSub {Γ = Γ} {τ1 = τ1} wf1 WFVarZ rewrite ↓↑invert Z τ1 = wf1
