...
module debruijn.debruijn-typing-subst where
  ...
  ... | wt2 = TALam (wf-TTSub-helper wf1 (helper-weaken wf2)) wt2
  wt-TtSub-helper {Θ = Θ} {n = n} {τ1 = τ1} ctxwf wf (TATLam wt) with wt-TtSub-helper {Θ = 1+ Θ} {n = 1+ n} {!   !} {!   !} {!   !}
  ...
  wt-TtSub-helper ctxwf wf (TATAp x wt x₁) = TATAp (wf-TTSub-helper wf (helper-weaken x)) (wt-TtSub-helper ctxwf wf wt) {!   !}
  wt-TtSub-helper ctxwf wf (TAEHole x) = TAEHole (wf-TTSub-helper wf (helper-weaken x))
  wt-TtSub-helper ctxwf wf (TANEHole x wt) = TANEHole (wf-TTSub-helper wf (helper-weaken x)) (wt-TtSub-helper ctxwf wf wt)
  wt-TtSub-helper ctxwf wf (TACast wt x x₁) = TACast (wt-TtSub-helper ctxwf wf wt) (wf-TTSub-helper wf (helper-weaken x)) (~TTSub-helper (weakening-n wf) (weakening-n (wf-ta ctxwf wt)) (weakening-n x) x₁)
