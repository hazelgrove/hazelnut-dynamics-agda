...
module binders-disjoint-checks where
  ...
  mutual
    ...
    lem-bd-lam (BDTLam bd) = BDTLam (lem-bd-lam bd)
  ...
  mutual
    ...
    lem-bd-hole (BDTLam bd) = BDTLam (lem-bd-hole bd)
  ...
  mutual
    ...
    lem-bd-cast (BDTLam bd) = BDTLam (lem-bd-cast bd)
  ...
  mutual
    ...
    lem-bd-failedcast (BDTLam bd) = BDTLam (lem-bd-failedcast bd)
  ...
  mutual
    ...
    lem-bd-into-cast (BDTLam bd) = BDTLam (lem-bd-into-cast bd)
