...
module binders-disjoint-checks where
  ...
  mutual
    ...
    lem-bd-lam (BDTLam bd (UBLam2 x x₁)) = BDTLam (lem-bd-lam bd) x₁
    ...
    lem-bd-lam (BDTAp x) = BDTAp (lem-bd-lam x)
  ...
  mutual
    ...
    lem-bd-hole (BDTLam bd (UBNEHole _ x)) = BDTLam (lem-bd-hole bd) x
    ...
    lem-bd-hole (BDTAp x) = BDTAp (lem-bd-hole x)
  ...
  mutual
    ...
    lem-bd-cast (BDTLam bd (UBCast x)) = BDTLam (lem-bd-cast bd) x
    ...
    lem-bd-cast (BDTAp x) = BDTAp (lem-bd-cast x)
  ...
  mutual
    ...
    lem-bd-failedcast (BDTLam bd (UBFailedCast x)) = BDTLam (lem-bd-failedcast bd) x
    ...
    lem-bd-failedcast (BDTAp x) = BDTAp (lem-bd-failedcast x)
  ...
  mutual
    ...
    lem-bd-into-cast (BDTLam bd x) = BDTLam (lem-bd-into-cast bd) (UBCast x)
    ...
    lem-bd-into-cast (BDTAp x) = BDTAp (lem-bd-into-cast x)
