...
module binders-disjoint-checks where
  ...
  mutual
    ...
    lem-bd-lam (BDTLam x) = BDTLam (lem-bd-lam x)
  ...
  mutual
    ...
    lem-bd-hole (BDTLam x) = BDTLam (lem-bd-hole x)
  ...
  mutual
    ...
    lem-bd-cast (BDTLam x) = BDTLam (lem-bd-cast x)
  ...
  mutual
    ...
    lem-bd-failedcast (BDTLam x) = BDTLam (lem-bd-failedcast x)
  ...
  mutual
    ...
    lem-bd-into-cast (BDTLam x) = BDTLam (lem-bd-into-cast x)
